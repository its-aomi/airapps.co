 ...
 *
 * @wordpress-plugin
 * Plugin Name: Spoter for Elementor
 * Plugin URI: https://1.envato.market/spoter-elementor
 * Description: Customizable hotspots for Elementor editor
 * Version: 1.0.2
...
use Merkulove\SpoterElementor\Caster;
use Merkulove\SpoterElementor\Config;
use Merkulove\SpoterElementor\Unity\Unity;
 ...
 *
 **/
final class SpoterElementor {

    /**
     * The one true SpoterElementor.
     *
     * @var SpoterElementor
     * @since 1.0.0
     * @access private
	...
	public static function on_activation() {
        ...
        /** Call Spoter on plugin activation */
...
register_activation_hook( __FILE__, [ SpoterElementor::class, 'on_activation' ] );

/** Run 'on_deactivation' when the plugin is deactivated. */
register_deactivation_hook( __FILE__, [ SpoterElementor::class, 'on_deactivation' ] );

/** Run Plugin class once after activated plugins have loaded. */
add_action( 'plugins_loaded', [ SpoterElementor::get_instance(), 'setup' ] );
